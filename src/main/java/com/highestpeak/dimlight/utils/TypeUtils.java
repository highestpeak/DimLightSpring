...
public class TypeUtils {
     ...
     */
    public static String typeStrDB(List<RSSSourceTag> types) {
        Collections.sort(types);
        List<String> typeNameList = types.stream().map(RSSSourceTag::getName).collect(Collectors.toList());
    ...
    public static List<RSSSourceTag> dbStrToTypeName(String dbStr) {
