		...
		if(type.equals("-1")) {
	    	...
	    	if(!isIntegerNumber(method) || Integer.parseInt(method)< 0 || Integer.parseInt(method)> 8) {
	    		System.out.println("Specify which method is used to solve the problem."
	    				+ "For single-document summarization: 1 - Lead, 2 - Centroid, 3 - ILP, 4 - LexPageRank, 5 -TextRank.java, 6 - Submodular;"
	    				+ "For multi-document summarization: 0 - Coverage, 1 - Lead, 2 - Centroid, 3 - ILP, 4 - LexPageRank, 5 - TextRank.java, 6 - Submodular, 7 - ClusterCMRW;"
			...
			/**
			 *  Solve the problem
			 *  Single-document summarization task: 1: Lead, 2: Centroid, 3: ILP, 4: LexPageRank, 5: TextRank.java, 6: Submodular;
			 * 	Multi-document summarization task: 0: Coverage, 1: Lead, 2: Centroid, 3: ILP, 4: LexPageRank, 5: TextRank.java, 6: Submodular, 7: ClusterCMRW;
